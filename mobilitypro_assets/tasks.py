...
def get_due_expense_entries():
	...
	rows = frappe.get_all('Adjustments Schedule',[['schedule_date', 'Between', [add_months(today(), -12), today()]], ['docstatus', '=', 1], ['journal_entry', '=', ''], ['parent','in',parent_names]], ['name', 'parent', 'adjustment_amount as amount'])
	return rows
